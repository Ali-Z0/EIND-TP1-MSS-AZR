...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.5\linewidth]{../../Simulations/premiere_partie/pont_diviseur}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.5\linewidth]{../../Simulations/premiere_partie/tension_3v3}
